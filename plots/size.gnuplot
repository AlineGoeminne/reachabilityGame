...
set title "Temps d'exécution moyen et médian et nombre de timeouts en fonction du nombre de nœuds (1000 générations par taille)"
...
plot 'naiveSize.data' using 2:xtic(1) title "Moyennes des temps d'exécution - C++ - générateur naïf" axes x1y1,\
    ...
    "sizePython.data" using 2:xtic(1) title "Moyenne des temps d'exécution - Python" axes x1y1,\
    "" using 3:xtic(1) title "Médiannes des temps d'exécution - Python" axes x1y1